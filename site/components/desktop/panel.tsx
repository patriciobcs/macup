...
export function Panel({ compact = false, className = "" }: { compact?: boolean; className?: string }) {
  ...
  return (
    <div
      className={`bg-background/90 w-[350px] max-w-full rounded-[12px] py-1.5 text-[13px] leading-[1.25] tracking-normal antialiased shadow-[0_18px_50px_rgba(0,0,0,0.45)] ring-1 ring-white/15 backdrop-blur-2xl ${className}`}
    >
